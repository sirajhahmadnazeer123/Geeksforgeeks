<h2><a href="https://www.geeksforgeeks.org/problems/count-alphabets3649/1?page=10&category=Strings&status=unsolved&sortBy=submissions">Count Alphabets</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string, The task is to count the number of&nbsp;alphabets present in the string.</span></p>
